  ...
  return (
    <div className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
      <div className="px-6 py-4 border-b border-slate-100">
        ...
        <p className="text-xs text-slate-400 mt-0.5">Configure the ordered steps per severity tier. Engine runs them in sequence until a response is received.</p>
      </div>
        ...
        {deviates && !earlyNineOneOne && (
          <div className="flex gap-3 bg-amber-50 border border-amber-200 rounded-xl px-4 py-3">
            ...
            <div className="space-y-0.5">
              <p className="text-xs font-semibold text-amber-800">Custom order — differs from recommendation</p>
      ...
      {!is911 && (
        <div className="flex items-center gap-2 pl-8">
          ...
          <input
            ...
            placeholder="+14155551234 — leave blank to skip call"
