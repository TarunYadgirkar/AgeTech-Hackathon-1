...
export default function Navbar({ isRunning, runStatus }: Props) {
      ...
      <div className="max-w-7xl mx-auto px-8 h-full flex items-center justify-between">
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            ...
            className="ml-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors shadow-sm"
          >
            Dashboard
          </button>
        </div>
