    ...
    <div className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
      ...
      {is911 && (
        <div className="mx-6 mt-5 bg-red-50 border border-red-200 rounded-xl p-5 text-center space-y-1.5">
          ...
          <p className="text-red-500 text-xs">Shown only. No real call is placed.</p>
        </div>
      )}
      ...
      {runStatus === 'completed' && (
        <div className="mx-6 mb-6 bg-emerald-50 border border-emerald-200 rounded-xl p-3 text-center">
          <p className="text-emerald-700 text-sm font-medium">Incident resolved. Someone took ownership.</p>
        </div>
      )}
      {runStatus === 'stopped' && (
